...
<b>1. Special Instructions for Reviewer and Author Signup: </b> <br/>
 ...
 As our field has grown considerably over the last five years, it is important that our reviewing process scales accordingly.  For the ACL2021 conference, we are creating a new review process with a goal to better manage conflict of interest (COI) and better match submissions with appropriate reviewers.  The big picture is that authors and reviewers must create or update a Global Profile and fill out the ACL2021 Reviewer/Author Information Form.  
...
<b>2. Paper Submission and Templates: </b>Submission is electronic, using the Softconf START conference management system.  The submission site is now available at: [https://www.softconf.com/acl2021/papers/](https://www.softconf.com/acl2021/papers/)
...
Style sheets (Latex, Word) are available here: [http://acl2021.org/downloads/acl2021-templates.zip](http://acl2021.org/downloads/acl2021-templates.zip)

And the Overleaf template is also available here: [https://www.overleaf.com/latex/templates/acl-2021-proceedings-template/zsrkcwjptpcd](https://www.overleaf.com/latex/templates/acl-2021-proceedings-template/zsrkcwjptpcd)
...
The 59th Annual Meeting of the Association for Computational Linguistics (ACL 2021) invites the submission of long and short papers on substantial, original, and unpublished research in all aspects of Computational Linguistics and Natural Language Processing. As in recent years, some of the presentations at the conference will be of papers accepted by the Transactions of the ACL (TACL) journal.  This year’s conference will for the first time also feature presentations of papers accepted by the Computational Linguistics (CL) journal.
...
ACL 2021 has the goal of a broad technical program. Relevant topics for the conference include, but are not limited to, the following areas (in alphabetical order):
...
The Overleaf template is also available here: [https://www.overleaf.com/latex/templates/acl-2021-proceedings-template/zsrkcwjptpcd](https://www.overleaf.com/latex/templates/acl-2021-proceedings-template/zsrkcwjptpcd)
...
All accepted papers must be presented at the conference to appear in the proceedings. Authors of papers accepted for presentation at ACL 2021 must notify the program chairs by the camera-ready deadline if they wish to withdraw the paper.

Previous presentations of the work (e.g. preprints on arXiv.org) should be indicated in a footnote in the final version of papers appearing in the ACL 2021 proceedings.  Please note that this footnote should not be in the submission version of the paper.

At least one author of each accepted paper must register for ACL 2021 by the early registration deadline.
...
1. [On the theme](https://acl2021.org/blog/theme/) <br/>
2. [On the archive papers and double submissions](https://acl2021.org/blog/arxiv-papers-double-submissions/)
